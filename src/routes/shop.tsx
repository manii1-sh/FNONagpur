  ...
  head: () => ({
    meta: [
      { title: "Shop — FNO Jaripatka" },
      {
        name: "description",
        content:
          "Browse our full collection of trendy clothing and accessories at FNO Jaripatka, Nagpur.",
      },
    ],
  }),
  component: ShopPage,
    ...
    <SiteLayout>
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 pt-8 sm:pt-12 pb-2 text-center">
        ...
        <p className="mt-3 text-sm text-ink/60 max-w-md mx-auto">
          Browse our complete collection — dresses, tops, shirts, skirts, accessories and more.
        </p>
      </div>
            ...
            {filtered.map((product) => (
              <div key={product.id} className="group relative flex flex-col">
                ...
                <div className="mt-2.5 flex flex-col flex-1 px-0.5">
                  {/* Category label — helpful when "All" filter is active */}
